...
async function houseListings2() {    
    const response = await fetch('http://127.0.0.1:3000/house-listings-2', {
        method: 'GET',
        credentials: "include",
    });
    ...
    for (let i = 0; i < data.houseListings.length; i++) {
        ...
        propertyMainImage.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].main_image;
        ...
        if(data.houseListings[i].image_1 != null) {
            ...
            image1.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_1;
        ...
        if(data.houseListings[i].image_2 != null) {
            ...
            image2.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_2;
        ...
        if(data.houseListings[i].image_3 != null) {
            ...
            image3.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_3;
        ...
        if(data.houseListings[i].image_4 != null) {
            ...
            image4.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_4;
        ...
        if(data.houseListings[i].image_5 != null) {
            ...
            image5.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_5;
        ...
        if(data.houseListings[i].image_6 != null) {
            ...
            image6.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_6;
        ...
        if(data.houseListings[i].image_7 != null) {
            ...
            image7.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_7;
        ...
        if(data.houseListings[i].image_8 != null) {
            ...
            image8.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_8;
        ...
        if(data.houseListings[i].image_9 != null) {
            ...
            image9.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_9;
        ...
        if(data.houseListings[i].image_10 != null) {
            ...
            image10.src = '../resources/PROPERTY/' + data.houseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.houseListings[i].property_id + '/' + data.houseListings[i].image_10;
