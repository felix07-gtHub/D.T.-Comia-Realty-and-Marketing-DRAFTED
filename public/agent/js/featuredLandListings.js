...
async function featuredLandListings() {    
    const response = await fetch('https://artclassic-production.up.railway.app/featured-land-listings', {
        method: 'GET',
        credentials: "include",
    });
    ...
    for (let i = 0; i < data.featuredLandListings.length; i++) {
        ...
        propertyImage.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].main_image;
        ...
        propertyMainImage.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].main_image;
        ...
        if(data.featuredLandListings[i].image_1 != null) {
            ...
            image1.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_1;
        ...
        if(data.featuredLandListings[i].image_2 != null) {
            ...
            image2.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_2;
        ...
        if(data.featuredLandListings[i].image_3 != null) {
            ...
            image3.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_3;
        ...
        if(data.featuredLandListings[i].image_4 != null) {
            ...
            image4.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_4;
        ...
        if(data.featuredLandListings[i].image_5 != null) {
            ...
            image5.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_5;
        ...
        if(data.featuredLandListings[i].image_6 != null) {
            ...
            image6.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_6;
        ...
        if(data.featuredLandListings[i].image_7 != null) {
            ...
            image7.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_7;
        ...
        if(data.featuredLandListings[i].image_8 != null) {
            ...
            image8.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_8;
        ...
        if(data.featuredLandListings[i].image_9 != null) {
            ...
            image9.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_9;
        ...
        if(data.featuredLandListings[i].image_10 != null) {
            ...
            image10.src = '../resources/PROPERTY/' + data.featuredLandListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredLandListings[i].property_id + '/' + data.featuredLandListings[i].image_10;
