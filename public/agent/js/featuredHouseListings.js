...
async function featuredHouseListings() {    
    ...
    for (let i = 0; i < data.featuredHouseListings.length; i++) {
        ...
        propertyImage.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].main_image;
        ...
        bathtubIcon.src = "../resources/AGENT ICONS/bathtub.png";
        ...
        propertyMainImage.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].main_image;
        ...
        if(data.featuredHouseListings[i].image_1 != null) {
            ...
            image1.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_1;
        ...
        if(data.featuredHouseListings[i].image_2 != null) {
            ...
            image2.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_2;
        ...
        if(data.featuredHouseListings[i].image_3 != null) {
            ...
            image3.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_3;
        ...
        if(data.featuredHouseListings[i].image_4 != null) {
            ...
            image4.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_4;
        ...
        if(data.featuredHouseListings[i].image_5 != null) {
            ...
            image5.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_5;
        ...
        if(data.featuredHouseListings[i].image_6 != null) {
            ...
            image6.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_6;
        ...
        if(data.featuredHouseListings[i].image_7 != null) {
            ...
            image7.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_7;
        ...
        if(data.featuredHouseListings[i].image_8 != null) {
            ...
            image8.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_8;
        ...
        if(data.featuredHouseListings[i].image_9 != null) {
            ...
            image9.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_9;
        ...
        if(data.featuredHouseListings[i].image_10 != null) {
            ...
            image10.src = '../resources/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_10;
        ...
        if(data.featuredHouseListings[i].image_2 != null) {
            ...
            previous.src = "../resources/BUYER ICONS AND LOGOS/left arrow-white.png"
            previous.alt = "Previous icon";
            previous.type = "";
            nextButton.classList.add('nextIcon');
            next.src = "../resources/BUYER ICONS AND LO/right arrow.png";
            next.alt = "Next icon";
            next.type = "";
