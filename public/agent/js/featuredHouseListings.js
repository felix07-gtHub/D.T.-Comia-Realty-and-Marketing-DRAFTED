...
async function featuredHouseListings() {    
    ...
    for (let i = 0; i < data.featuredHouseListings.length; i++) {
        ...
        propertyImage.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].main_image;
        propertyImage.alt =  data.featuredHouseListings[i].main_image;
        propertyImage.type = "";
        ...
        propertyMainImage.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].main_image;
        propertyMainImage.alt = data.featuredHouseListings[i].main_image;
        ...
        if(data.featuredHouseListings[i].image_1 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image1 = document.createElement('img');

            image1.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_1;
            image1.alt =  data.featuredHouseListings[i].image_1;
            image1.type = "";
        ...
        if(data.featuredHouseListings[i].image_2 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image2 = document.createElement('img');

            image2.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_2;
            image2.alt =  data.featuredHouseListings[i].image_2;
            image2.type = "";
        ...
        if(data.featuredHouseListings[i].image_3 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image3 = document.createElement('img');

            image3.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_3;
            image3.alt =  data.featuredHouseListings[i].image_3;
            image3.type = "";
        ...
        if(data.featuredHouseListings[i].image_4 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image4 = document.createElement('img');

            image4.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_4;
            image4.alt =  data.featuredHouseListings[i].image_4;
            image4.type = "";
        ...
        if(data.featuredHouseListings[i].image_5 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image5 = document.createElement('img');

            image5.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_5;
            image5.alt =  data.featuredHouseListings[i].image_5;
            image5.type = "";
        ...
        if(data.featuredHouseListings[i].image_6 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image6 = document.createElement('img');

            image6.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_6;
            image6.alt =  data.featuredHouseListings[i].image_6;
            image6.type = "";
        ...
        if(data.featuredHouseListings[i].image_7 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image7 = document.createElement('img');

            image7.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_7;
            image7.alt =  data.featuredHouseListings[i].image_7;
            image7.type = "";
        ...
        if(data.featuredHouseListings[i].image_8 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image8 = document.createElement('img');

            image8.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_8;
            image8.alt =  data.featuredHouseListings[i].image_8;
            image8.type = "";
        ...
        if(data.featuredHouseListings[i].image_9 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image9 = document.createElement('img');

            image9.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_9;
            image9.alt =  data.featuredHouseListings[i].image_9;
            image9.type = "";
        ...
        if(data.featuredHouseListings[i].image_10 != null) {
            imageCount++;

            const imageDiv = document.createElement('div');
            const image10 = document.createElement('img');

            image10.src = 'https://niwxujzmwpdhegjlmyfw.supabase.co/storage/v1/object/public/D.T.%20Comia%20Realty%20and%20Marketing/PROPERTY/' + data.featuredHouseListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.featuredHouseListings[i].property_id + '/' + data.featuredHouseListings[i].image_10;
            image10.alt =  data.featuredHouseListings[i].image_1;
            image10.type = "";
