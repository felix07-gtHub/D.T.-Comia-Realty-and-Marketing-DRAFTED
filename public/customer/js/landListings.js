...
async function landListings() {    
    ...
    const response = await fetch('https://artclassic-production.up.railway.app/land-listings', {
        method: 'POST',
        headers: {                    
                    'User-Agent': 'undici-stream-example',
                    'Content-Type': 'application/json',
    ...
    for (let i = 0; i < data.landListings.length; i++) {
        ...
        if(data != "") {
            ...
            propertyMainImage.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].main_image;
            ...
            if(data.landListings[i].image_1 != null) {
                ...
                image1.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_1;
            ...
            if(data.landListings[i].image_2 != null) {
                ...
                image2.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_2;
            ...
            if(data.landListings[i].image_3 != null) {
                ...
                image3.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_3;
            ...
            if(data.landListings[i].image_4 != null) {
                ...
                image4.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_4;
            ...
            if(data.landListings[i].image_5 != null) {
                ...
                image5.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_5;
            ...
            if(data.landListings[i].image_6 != null) {
                ...
                image6.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_6;
            ...
            if(data.landListings[i].image_7 != null) {
                ...
                image7.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_7;
            ...
            if(data.landListings[i].image_8 != null) {
                ...
                image8.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_8;
            ...
            if(data.landListings[i].image_9 != null) {
                ...
                image9.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_9;
            ...
            if(data.landListings[i].image_10 != null) {
                ...
                image10.src = '../resources/PROPERTY/' + data.landListings[i].location.replace(/[,]/g, "").replace(/[ ]/g, "_") + '/' + data.landListings[i].property_id + '/' + data.landListings[i].image_10;
