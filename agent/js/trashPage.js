...
async function deleteThirtyDaysProperty(propertyIdInput) {
    const response = await fetch('http://127.0.0.1:3000/delete-thirty-days-property', {
        method: 'POST',
        headers: {                    
...
async function deletedListings() {    
    const response = await fetch('http://127.0.0.1:3000/deleted-listings', {
        method: 'GET',
        credentials: "include",
    });
    ...
    if(data.deletedPropertyListings.length > 0) {
        for (let i = 0; i < data.deletedPropertyListings.length; i++) {  
            ...
            if( d > dateDeletion) {
                ...
                propertyMainImage.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].main_image;
                ...
                if(data.deletedPropertyListings[i].image_1 != null) {
                    ...
                    image1.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_1;
                ...
                if(data.deletedPropertyListings[i].image_2 != null) {
                    ...
                    image2.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_2;
                ...
                if(data.deletedPropertyListings[i].image_3 != null) {
                    ...
                    image3.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_3;
                ...
                if(data.deletedPropertyListings[i].image_4 != null) {
                    ...
                    image4.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_4;
                ...
                if(data.deletedPropertyListings[i].image_5 != null) {
                    ...
                    image5.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_5;
                ...
                if(data.deletedPropertyListings[i].image_6 != null) {
                    ...
                    image6.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_6;
                ...
                if(data.deletedPropertyListings[i].image_7 != null) {
                    ...
                    image7.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_7;
                ...
                if(data.deletedPropertyListings[i].image_8 != null) {
                    ...
                    image8.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_8;
                ...
                if(data.deletedPropertyListings[i].image_9 != null) {
                    ...
                    image9.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_9;
                ...
                if(data.deletedPropertyListings[i].image_10 != null) {
                    ...
                    image10.src = '../resources/PROPERTY/' + data.deletedPropertyListings[i].location.replace(/\s/g, "").replace(/\W/g, "_") + '/' + data.deletedPropertyListings[i].property_id + '/' + data.deletedPropertyListings[i].image_10;
                ...
                if(data.deletedPropertyListings[i].image_2 != null) {
                    ...
                    next.src = "../resources/BUYER ICONS AND LOGOS/right arrow.png";
                    next.alt = "Next icon";
                    next.type = "";
    ...
    if (imageContainerPorperty1.children.length > 1) {
        ...
        for(let i = 0; i < listings.children.length; i++) {
            if(listings.children[i].classList == 'property') {
                ...
                select.src = "../resources/AGENT ICONS/agent uncheckbox.png";
                ...
                function selectCheckboxFunction() {
                    if(selectCheckbox.checked != true) {
                        ...
                        select.src = "../resources/AGENT ICONS/agent checkbox.png";
...
async function restoreAll(propertyIdInput) {
    const response = await fetch('http://127.0.0.1:3000/restore-all-property', {
        method: 'POST',
        headers: {                    
                    'User-Agent': 'undici-stream-example',
                    'Content-Type': 'application/json'
...
async function deleteAll(propertyIdInput) {
    const response = await fetch('http://127.0.0.1:3000/delete-all-property', {
        method: 'POST',
        headers: {                    
                    'User-Agent': 'undici-stream-example',
                    'Content-Type': 'application/json'
