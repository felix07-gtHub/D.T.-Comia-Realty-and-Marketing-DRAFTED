            ...
            connection.query(selectUserIdQuery, (err, sselectUserIdResult) => {
              ...
              if(sselectUserIdResult.length > 0) {
                for(let i = 0; i < sselectUserIdResult.length; i++) {
                  if(sselectUserIdResult[0].uesr_id == userId) {
                    userIdFunction();
    ...
    if(selectForgetPasswordResult.length > 0) {
      if(recoveryEmailAddressInput != selectForgetPasswordResult[0].recovery_email_address) {
        ...
        if(newPassword != "NEW PASSWORD NOT FOUND!" && confirmPassword != "CONFIRM PASSWORD NOT FOUND!") {
          ...
          connection.query(updateeCustomerPasswordQuery, updateeCustomerPasswordValue, (err, updateeCustomerPasswordResult) => {
            if(err) {throw err};
...
app.get('/featured-property', (req, res) => {
  ...
  const selectFeaturedPropertyListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE status != "SOLD" AND date_featured IS NOT NULL AND date_deleted IS NULL';
...
app.post('/house-listings', (req, res) => {
  ...
  let selectHouseListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE status != "SOLD" AND date_deleted IS NULL AND price >= ? and price <= ? AND ' + propertyTypeInput;
  ...
  if(sortInput != ": Default") {
    ...
    if(sortInput == ": Price ↑") {
      selectHouseListingsQuery += ' price_formated DESC';
    } else if(sortInput == ": Price ↓") {
      selectHouseListingsQuery += ' price_formated ASC';
...
app.post('/land-listings', (req, res) => {
  ...
  if(bedroomsInput != "") {
    selectLandListingsQuery +=(' AND room_count = ?');
    sortValue.push(bedroomsInput);
  };

  if(bathroomsInput != "") {
    selectLandListingsQuery +=(' AND bath_count = ?');
    sortValue.push(bathroomsInput);
  };
  ...
  if(sortInput != ": Default") {
    ...
    if(sortInput == ": Price ↑") {
      selectLandListingsQuery += ' price_formated DESC';
    } else if(sortInput == ": Price ↓") {
      selectLandListingsQuery += ' price_formated ASC';
    } else if(sortInput == ": Date ↑") {
...
app.get('/saved-property', (req, res) => {
  ...
  const selectPropertyListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE date_deleted IS NULL';
...
app.post('/property-information', (req, res) => {
  ...
  const selectPropertyInformationQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE property_id = ? AND status = "AVAILABLE" AND date_deleted IS NULL';
    ...
    if(req.session.userId != undefined) {
      ...
      connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
        ...
        if(selectTypeOfUserResult[0].type_of_user != "Customer") {
          ...
          const insertReservationQuery = 'INSERT INTO reservation_table (agent_id, customer_id, property_id, reservation_id, full_name, contact_number, email_address, property, reservation_period_from, reservation_period_to, status) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
                
            //  DECLARES insertReservationValue.
          const insertReservationValue = [selectPropertyInformationResult[0].user_id, userId, propertyId, null, fullNameInput, contactNumberInput, emailAddressInput, selectPropertyInformationResult[0].address, reservataionPeriodFromInput, reservataionPeriodToInput, status];
          ...
          connection.query(insertReservationQuery, insertReservationValue, (err, insertReservationQuery) => {
            ...
            const reservedPropertyValue = [userId, propertyId]
        ...
        connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
          ...
          if(selectTypeOfUserResult[0].type_of_user != "Customer") {
            ...
            res.json("");
              ...
              //  SELECT RESERVATION LISTINGS QUERY.
            const selectReservationListingsQuery = 'SELECT agent_id, customer_id, property_id, reservation_id, full_name, contact_number, email_address, property, reservation_period_from, reservation_period_to, status, date_archived, reason_for_cancelling, note FROM reservation_table WHERE customer_id = ? AND status = "on going"';
  ...
  if(req.session.userId != undefined) {
    ...
    connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") { 
        ...
        const selectFeaturedHouseListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND (property_type = "bungalow" OR property_type = "two-storey house" OR property_type = "one-and-a-half storey house" OR property_type = "multi-storey house" OR property_type = "split-level house" OR property_type = "duplex" OR property_type = "triplex / fourplex" OR property_type = "townhouse / row house" OR property_type = "semi-detached house" OR property_type = "single-detached house" OR property_type = "modern house" OR property_type = "contemporary house" OR property_type = "villa" OR property_type = "cottage" OR property_type = "farmhouse" OR property_type = "beach house" OR property_type = "rest house / vacation home") AND date_featured IS NOT NULL AND date_deleted IS NULL ORDER BY date_featured';
  ...
  if(req.session.userId != undefined) {
    ...
    connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") { 
        ...
        const selectFeaturedLandListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND (property_type = "residential lot" OR property_type = "commercial lot" OR property_type = "industrial lot" OR property_type = "agricultural / farm land" OR property_type = "subdivision lot" OR property_type = "beachfront lot" OR property_type = "mountain / hillside lot" OR property_type = "mixed-use lot" OR property_type = "vacant lot" OR property_type = "raw land" OR property_type = "investment lot") AND date_featured IS NOT NULL AND date_deleted IS NULL ORDER BY date_featured';
  ...
  if(req.session.userId != undefined) {
    ...
    connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") { 
        ...
        const selectlandListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND (property_type = "residential lot" OR property_type = "commercial lot" OR property_type = "industrial lot" OR property_type = "agricultural / farm land" OR property_type = "subdivision lot" OR property_type = "beachfront lot" OR property_type = "mountain / hillside lot" OR property_type = "mixed-use lot" OR property_type = "vacant lot" OR property_type = "raw land" OR property_type = "investment lot") AND date_featured IS NULL AND date_deleted IS NULL';
  ...
  if(req.session.userId != undefined) {
    ...
    connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") {
        ...
        const selectPropertyListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND property_id = ? AND date_deleted IS NULL';
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") { 
          ...
          connection.query(selectReservationListingsQuery, selectReservationListingsValue, (err, selectReservationListingsResult) => {
            if (err) {throw err};
                ...
                //  SELECT PROPERTY LISTINGS QUERY.
              const selectPropertyListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND date_deleted IS NULL';
  ...
  if(req.session.userId != undefined) {
    ...
    connection.query(selectTypeOfUserQuery, userId, (err, selectTypeOfUserResult) => {
      ...
      if(selectTypeOfUserResult[0].type_of_user != "Agent") {
        ...
        const selectDeletedPropertyListingsQuery = 'SELECT property_id, user_id, location, address, main_image, image_1, image_2, image_3, image_4, image_5, image_6, image_7, image_8, image_9, image_10, property_type, FORMAT(price, 2) AS price_formated, area, room_count, bath_count, description, status, date_featured, date_created, date_deleted FROM property_table WHERE user_id = ? AND (date_deleted IS NOT NULL AND date_deleted > "1970-01-01 00:00:00") ORDER BY date_deleted';
